...
import { getAllPackages, getPackagesByDimensions } from '../../services/packageService';
    ...
    <div className="home-page">
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p>Enter your room dimensions to discover the ideal furniture package</p>
      ...
      {showOrderForm && selectedPackage && (
        <div className="order-form-overlay">
          <div className="order-form-container">
            ...
            <h3>{selectedPackage.name} - ${selectedPackage.price.toFixed(2)}</h3>
